    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="内容" prop="content">
        <div class="editor-toolbar">
          ...
          <el-button @click="insertMarkdown('[', '](url)')" title="链接"><u>U</u></el-button>
          <el-divider direction="vertical" />
          <el-button @click="insertMarkdown('- ')" title="列表">列表</el-button>
          <el-button @click="insertMarkdown('> ')" title="引用">引用</el-button>
          <el-button @click="insertMarkdown('```', '```')" title="代码块">代码</el-button>
          <el-divider direction="vertical" />
...
import { createArticleApi, updateArticleApi, getArticleApi, getCategoriesApi } from '@/api'
